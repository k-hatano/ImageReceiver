...
public class ImageReceiverCanvas extends Canvas implements MouseListener, MouseMotionListener, MouseWheelListener, KeyListener {
	ImageReceiver parent;
	Image iFileImage = null;

	public ImageReceiverCanvas(ImageReceiver ImageReceiver) {
